...
function rechercherVainqueur(pions, joueurs, tour) {
  if (
    ...
    pions[0].style.backgroundColor = "#ff00e8";
    pions[1].style.backgroundColor = "#ff00e8";
    pions[2].style.backgroundColor = "#ff00e8";
    return true;
  }
  ...
  if (
    ...
    pions[3].style.backgroundColor = "#ff00e8";
    pions[4].style.backgroundColor = "#ff00e8";
    pions[5].style.backgroundColor = "#ff00e8";
    return true;
  }
  ...
  if (
    ...
    pions[6].style.backgroundColor = "#ff00e8";
    pions[7].style.backgroundColor = "#ff00e8";
    pions[8].style.backgroundColor = "#ff00e8";
    return true;
  }
